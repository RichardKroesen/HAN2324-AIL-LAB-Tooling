...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = M_INT1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(M_INT1_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = JP9_Pin|M_INT2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = LSM6DSM_INT1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(LSM6DSM_INT1_GPIO_Port, &GPIO_InitStruct);
